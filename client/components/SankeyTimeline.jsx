...
class SankeyTimeline extends React.Component {
  ...
  createD3Sankey() {
    d3.sankey = function() {
      ...
      d3.sankey.nodeWidth = function(_) {
        if (!arguments.length) return nodeWidth;
        nodeWidth = +_;
        return sankey;
      };
      
      d3.sankey.nodePadding = function(_) {
        if (!arguments.length) return nodePadding;
        nodePadding = +_;
        return sankey;
      };
      
      d3.sankey.nodes = function(_) {
        if (!arguments.length) return nodes;
        nodes = _;
        return sankey;
      };
      
      d3.sankey.links = function(_) {
        if (!arguments.length) return links;
        links = _;
        return sankey;
      };
      
      d3.sankey.size = function(_) {
        if (!arguments.length) return size;
        size = _;
        return sankey;
      };
      
      d3.sankey.layout = function(iterations) {
        computeNodeLinks();
        computeNodeValues();
        computeNodeBreadths();
      ...
      d3.sankey.relayout = function() {
        computeLinkDepths();
        return sankey;
      };
      
      d3.sankey.link = function() {
        var curvature = 0.5;
  ...
  createD3DomElements() {
    ...
    var formatNumber = d3.format(',.0f'), // zero decimal places
      ...
      color = scaleOrdinal().range(['red', 'green', 'blue', '#6b486b', '#a05d56', '#d0743c', '#ff8c00'])
