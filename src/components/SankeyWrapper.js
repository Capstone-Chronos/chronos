...
export default class SankeyWrapper extends React.Component {
  ...
  render() {
    return (<div>
      <SankeyTools nodes={this.state.nodes} links={this.state.links} addNode={this.addNode} addLink={this.addLink} />
      <Sankey nodes={this.state.nodes} links={this.state.links} />
    </div>
    )
  }
}