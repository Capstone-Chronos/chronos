...
=======
    ...
    return (
      <div>
        <SankeyTools nodes={this.state.nodes} links={this.state.links} addNode={this.addNode} openModal={this.openModal} addLink={this.addLink} />
        <Sankey nodes={this.state.nodes} links={this.state.links} openModal={this.openModal} />
        <Modal
          closeTimeoutMS={150}
          isOpen={this.state.modalIsOpen}
